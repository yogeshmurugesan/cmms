...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="content">
                            <fieldset>
                                ...
                                <%
                                            ...
                                            String sql = "SELECT * FROM mark where idno='" + s2 + "'  ";
                                ...
                                <!-- First -->
                                <form action="revalapplydo.jsp" method="post" name="form1" onsubmit="check()">
                                    <table border= "0" id = "tblSample" class="table table-bordered table-striped">
                                        ...
                                        %>
                                        <tr>
                                            <td ><input type="checkbox" name="c" id="c" value="<%=pi%>" /></td>
                                            <td><%=pi%> </td>
                                            <td><%=pn%> </td>
                                            <td><%=in%> </td>
                                            <td><%=ex%> </td>
                                        ...
                                        <input type="hidden" name="h1" id="h1" value="<%=i%>" />
        ...
        {
            var str="";
            for (var i = 0; i < form1.c.length; i++) {
                if(form1.c[i].checked) {
                    if(str=="")
                    {
                        str=form1.c[i].value;
                    }else{
                        str=str+","+form1.c[i].value;
                    }
                }
            }
          //   alert(str);
