            ...
            <div class="container">
                ...
                <div class="hero-unit">
                    <form name="form1" class="form-horizontal" method="post" action="#" onSubmit="return checknull()">
                        <fieldset>
                            <h3>    <legend>USER Details</legend> </h3>


                            <div class="control-group">
                                <label class="control-label" for="t1">User id(no)</label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <font color="red" class="space5">  <span class="help-inline"> Question!</span> </font>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <font color="#049cdb" class="space5">   <p>Password changes</p> </font>
        ...
        <%
                    ...
                    if (s1 == null && s2 == null && s3 == null && s4 == null) {
                        ...
                        if (session.getAttribute("user").equals(s1)) {
                            String sql = "UPDATE userlog SET quest='" + s3 + "',ans='" + s2 + "',pass='" + s4 + "' WHERE id='" + s1 + "' ";
