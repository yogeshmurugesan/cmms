    ...
    <body onload="favBrowser()">
                ...
                <div class="hero-unit">
                    ...
                    <div class="nano" style="height: 450px; ">
                        <div class="content">
                            ...
                            <fieldset>
                                <h3>    <legend>ARREAR MARK ENTRY</legend> </h3>
                                <form name="form1" class="form-horizontal" method="post" action="arrearsmarkdo.jsp" onSubmit="return checknull()">
        ...
        <script type="text/javascript">
            ...
            function favBrowser2()
            {
                ...
                xmlhttp.open("GET","get12.jsp?q="+str+"&q1="+str1,true);
                xmlhttp.send();
            }
            function favBrowser3()
            {
                ...
                xmlhttp.open("GET","get10.jsp?q="+str+"&q1="+str1,true);
                xmlhttp.send();
            }
