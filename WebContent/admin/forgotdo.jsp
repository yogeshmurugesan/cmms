                ...
                <div class="hero-unit">
                    ...
                    <div class="nano" style="height: 450px; ">
                        <div class="content">
                            ...
                            <form name="form1" class="form-horizontal" method="post" action="forgotdo1.jsp" onSubmit="return checknull()">
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="t3">User name is</label>
                                        <div class="controls">

                                            <div class="input-prepend">
                                                <span class="add-on"><i class="icon-user"></i></span>
                                                <input type="text" class="input-large" id="t3" name="t3" value='<%=s1%>' />
                                            </div>
                                        </div>
                                    </div>
                                            
                                    <div class="control-group">
                                        <label class="control-label" for="t1">Security Question</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="t2">Your ans</label>
                                        <div class="controls">

                                            <div class="input-prepend">
                                                <span class="add-on"><i class="icon-user"></i></span>
                                                <input type="text" class="input-large" id="t2" name="t2" placeholder="your ans.."/>
                                            </div>
                                        </div>
                                    </div>
