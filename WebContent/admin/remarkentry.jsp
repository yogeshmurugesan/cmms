    ...
    <body onload="favBrowser()">
                ...
                <div class="hero-unit">
                    <div class="nano" style="height: 450px; ">
                        <div class="content">
                            ...
                            <fieldset>
                                <h3>    <legend>REVALUATION MARK ENTRY</legend> </h3>
                                <form name="form1" class="form-horizontal" method="post" action="remarkentrydo.jsp" onSubmit="return checknull()">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <select name="o3" id="o3" onchange="favBrowser2()">
                                                <option value="-1">--select--</option>
                                            </select>
        ...
        <script type="text/javascript">
            ...
            function favBrowser1()
            {
                ...
                xmlhttp.open("GET","get13.jsp?q="+str,true);
                xmlhttp.send();
            }
            ...
            function favBrowser2()
            {
                ...
                xmlhttp.open("GET","get14.jsp?q="+str+"&q1="+str1,true);
                xmlhttp.send();
            }
