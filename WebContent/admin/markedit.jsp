    ...
    <body onload="favBrowser()">
                ...
                <div class="hero-unit">
                    ...
                    <div class="nano" style="height: 450px; ">
                        <div class="content">
                            ...
                            <fieldset>
                                <h3>    <legend>MARK EDIT</legend> </h3>
                                <form name="form1" class="form-horizontal" method="post" action="markeditdo.jsp" onSubmit="return checknull()">
        ...
        <script type="text/javascript">
            ...
            function favBrowser3()
            {
                ...
                xmlhttp.open("GET","get11.jsp?q="+str+"&q1="+str1,true);
                xmlhttp.send();
            }
