    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="nav-collapse">
                        <ul class="nav">
                            ...
                            <!-- 7 add a admin -->
                            <li class="bar active" id="admin"><a href="addadmin.jsp"><i class="icon-plus-sign icon-white"></i>&nbsp;Add A Admin</a></li>
                ...
                <div class="hero-unit">
                    <form name="form1" class="form-horizontal" method="post" action="#" onSubmit="return checknull()">
                        <fieldset>
                            ...
                            <div class="control-group">
                                <label class="control-label" for="t2">Admin Password</label>
                                <div class="controls">
                                    <div class="input-prepend">
                                        <span class="add-on"><i class="icon-asterisk"></i></span>
                                        <input type="text" class="input-large" id="t2" name="t2" placeholder="password..."/><br><br>
                                    </div>
                                </div>
                            </div>
        ...
        <%
                    ...
                    Statement st = c.createStatement();
                        ...
                        String sql = "INSERT INTO adminlog (name,pass) VALUES ('" + s1 + "','" + s2 + "')  ";
