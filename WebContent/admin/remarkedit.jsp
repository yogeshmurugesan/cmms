    ...
    <body onload="favBrowser()">
                ...
                <div class="hero-unit">
                    <div class="nano" style="height: 450px; ">
                        <div class="content">
                            ...
                            <fieldset>
                                <h3>    <legend>REVALUATION MARK EDIT</legend> </h3>
                                <form name="form1" class="form-horizontal" method="post" action="remarkeditdo.jsp" onSubmit="return checknull()">
        ...
        <script type="text/javascript">
            ...
            function favBrowser1()
            {
                ...
                xmlhttp.open("GET","get15.jsp?q="+str,true);
                xmlhttp.send();
            }
            ...
            function favBrowser2()
            {
                ...
                xmlhttp.open("GET","get16.jsp?q="+str+"&q1="+str1,true);
                xmlhttp.send();
            }
