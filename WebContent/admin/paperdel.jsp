...
<html lang="en">
    ...
    <body onload="favBrowser()">
            ...
            <div class="container">
                ...
                <div class="hero-unit">
                    <form name="form1" class="form-horizontal" method="post" action="#" onSubmit="return checknull()">
                        <fieldset>
                            <h3>    <legend>PAPER DELETING</legend> </h3>
                            ...
                            <div class="control-group">
                                <label class="control-label" for="o2">Select paper id</label>
                                <div class="controls">
                                    <select id="o2" name="o2" onchange="favBrowser2()" >
                                        <option value="--select--">--select--</option>
                                    </select>
                                    <font color="red" class="space5">   <span class="help-inline"> id!</span> </font>
                                </div>
                            </div>

                            <div class="control-group">
                                <label class="control-label" for="t1">Paper name</label>
                                <div class="controls">
                                    <input type="text" class="input-large" id="t1" name="t1" disabled  placeholder="paper name.."/>
                                    <font color="red">   <span class="help-inline" color="green">paper name!</span> </font>
        ...
        <script type="text/javascript">
            ...
            {
                document.getElementById("o2").options.length = 0;
                ...
                xmlhttp.onreadystatechange=function()
                {
                    if (xmlhttp.readyState==4 && xmlhttp.status==200)
                    {
                        ...
                        for(i=0;i<n.length;i++)
                        {
                            var x=document.getElementById("o2");
                            var option=document.createElement("option");
                ...
                xmlhttp.open("GET","get6.jsp?q="+str,true);
                xmlhttp.send();
            }
            ...
            function favBrowser2()
            {
                ...
                var str=o2.options[o2.selectedIndex].text;
                ...
                xmlhttp.open("GET","get5.jsp?q="+str,true);
                xmlhttp.send();
            }
        ...
        <%
                    ...
                    if (s1 == null && s2 == null ) {
                        ...
                        String sql = "delete from papers where id='" + s2 + "' ";
                        int i = st.executeUpdate(sql);
                        if (1 <= i) {
                            out.println(" <script> alert('Paper deleted successfuly'); </script> ");
                        }
