...
<%
            ...
            for (int k = 0; k < j; k++) {
                ...
                sql = "update reval set dept='" + s1 + "',idno='" + s2 + "',name='" + s4 + "',sem='" + s3 + "',pid='" + pa1[k] + "',pname='" + pa2[k] + "',inter=" + in1[k] + ",exter=" + ex1[k] + ",total=" + to + ",code='" + co + "'   where idno='" + s2 + "' and pid='" + pa1[k] + "'  ";
            ...
            if (1 <= i) {
                ...
                response.sendRedirect("remarkedit.jsp");
            }
