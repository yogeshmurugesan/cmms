    ...
    <body  onload="favBrowser()">
        ...
        <div class="navbar navbar-fixed-top">
            ...
            <div class="container">
                ...
                <div class="hero-unit">
                    ...
                    <form name="form1" class="form-horizontal" method="get" action="#" onSubmit="return checknull()">
                        <fieldset>
                            <h3>    <legend>USER DELETING</legend> </h3>
        ...
        <%
                ...
                if (s1 == null && s2 == null && s3 == null) {
                    ...
                    String sql = "delete from userlog where id='" + s3 + "' ";
                    int i = st.executeUpdate(sql);
                    if (1 <= i) {
                        out.println(" <script> alert('User deleted successfuly'); </script> ");
                    }
