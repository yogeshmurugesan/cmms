    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="nav-collapse">
                        <ul class="nav">
                            ...
                            <!-- 3 Department -->
                            <li class="bar active" id="dept"><a href="dept.jsp">Department</a></li>
            ...
            <div class="container">
                ...
                <div class="hero-unit">
                    <form name="form1" class="form-horizontal" method="post" action="#" onSubmit="return checknull()">
                        ...
                        <fieldset>
                            <h3>    <legend>Department Addition</legend> </h3>


                            <div class="control-group">
                                <label class="control-label" for="t1">Department Name</label>
                                <div class="controls">
                                    <div class="input-prepend">
                                        <input type="text" class="input-large" id="t1" name="t1" placeholder="Dept name.."/>
                                        <span class="help-inline"> (new)!</span>
                                    </div>
                                </div>
                            </div>
        ...
        <%
                    ...
                    if (s1 == null) {
                        ...
                        String sql = "INSERT INTO dept VALUES ('" + s1 + "')  ";
